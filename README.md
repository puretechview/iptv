...
```bash
  https://puretechview.github.io/iptv/playlist/freemiumpro.m3u
```

## IPTV (BDIX CONNECTED CHANNELS HARE)

```bash
  https://puretechview.github.io/iptv/playlist/iptv.m3u
```

## SPORTS CHANNLES

```bash
  https://puretechview.github.io/iptv/playlist/sports.m3u
```

## RANDOM CHANNELS

```bash
  https://puretechview.github.io/iptv/playlist/freemium.m3u
```
